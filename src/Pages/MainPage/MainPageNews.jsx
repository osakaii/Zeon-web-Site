...
import styles from './styles/MainPageNew.module.scss'
            ...
            <div className="container">
                <div className={styles.newContent}>
                    <div className={styles.titleAndLink}>
                        ...
                        <Link to="/blog" className={styles.link}>See all</Link>
                    </div>
                    <div className={styles.newsWrapper}>
                        {
                            fetchedNews.map(( news, index )=>{
                                return (
                                    <NewsBlock key = {news.title + index} title = {news.title} image = {news.image} date = {news.date} desc = {news.desc}/>
                                )
                            })
                        }
                    </div>
