...
function Pagination({ current ,setQuestionIndex, maxPage}) {
  return (
    <div className={styles.pagination}>
        ...
        <button onClick={() => setQuestionIndex(prev => prev === maxPage ? maxPage : prev += 1)} className={styles.next}>Далее</button>
    </div>
  )
}
